    ...
    <div className="max-w-[1280px] mx-auto">
        <div className="flex md:pl-10 space-x-3 md:space-x-10">
            <div className="flex flex-col items-center">
                ...
                <motion.div initial={{height:0}} whileInView={{height:'100%'}} transition={{duration:0.4, delay:0.3}} className="h-full w-[3px] max-md:w-[2px] mt-7 rounded-md bg-gradient-to-b from-[#733787]"></motion.div>
            </div>
