    ...
    <li onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} >
        ...
        <div className={`relative lg:absolute -ml-5 bg-white rounded-md lg:py-4 p-6 w-[300px] transition ease-in duration-300 ${show ? "opacity-100 " : "opacity-0 hidden top-[2000px]"}`}>
            <div className='lg:border-b-[1px] mb-4 pb-6 pt-4 w-full'>
                <span className='text-neutral-800 font-semibold text-base hover:text-blue-500'>GitHub Sponser <p className='text-sm font-normal text-neutral-500'>Fund open source developers</p></span>
            </div>
            <div className='lg:border-b-[1px] mb-4 pb-6 pt-4 w-full'>
                <span className='text-neutral-800 font-semibold text-base hover:text-blue-500'>The ReadMe Projects <p className='text-sm font-normal text-neutral-500'>GitHub community articles</p></span>
            </div>
            <div className='mb-4 pt-2 w-full pb-0'>
